(function initializeSportbukChatWidget() {
    if (window.__sportbukChatWidgetInitialized) {
        return;
    }

    window.__sportbukChatWidgetInitialized = true;
    ...
    function getStoredUser() {
        ...
        try {
            const raw = localStorage.getItem(window.CONFIG?.STORAGE_KEYS?.USER_INFO || 'sportbuk_user_info') || localStorage.getItem('userInfo');
    ...
    function getAuthToken() {
        return localStorage.getItem(window.CONFIG?.STORAGE_KEYS?.AUTH_TOKEN || 'sportbuk_auth_token')
    ...
    function normalizeMessage(message) {
        ...
        return {
            ...
            actor,
            name: message.senderName || (actor === 'self' ? 'Bạn' : 'Admin SPORTBUK'),
                    ...
                    <div class="chat-widget-header-top">
                        <div>
                            <h2 class="chat-widget-title">
                                <img class="chat-widget-brand-logo" src="/frontend/assets/logos/dark-full.png" alt="SPORTBUK">
                                <span>Support</span>
                            </h2>
