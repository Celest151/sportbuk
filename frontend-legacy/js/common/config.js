...
function normalizeMediaPath(value) {
    ...
    if (/^\/frontend\/assets\//i.test(source)) {
        return source;
    }
...
const STORAGE_KEYS = {
    AUTH_TOKEN: 'sportbuk_auth_token',
    REFRESH_TOKEN: 'sportbuk_refresh_token',
    USER_INFO: 'sportbuk_user_info',
    CART: 'sportbuk_cart',
    WISHLIST: 'sportbuk_wishlist',
    THEME: 'sportbuk_theme'
};
