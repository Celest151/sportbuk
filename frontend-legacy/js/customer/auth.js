...
function redirectAfterAuth(data) {
    ...
    const requestedRedirect = redirectParams.get('redirect') || sessionStorage.getItem('sportbuk_post_auth_redirect');
    sessionStorage.removeItem('sportbuk_post_auth_redirect');
